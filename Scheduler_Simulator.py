...
def Preparing_Simulation():
    ...
    elif selected_algorithm.get() == 'Preemptive_Priority':
        Arrival_Times, Burst_Times, Priorities = Ask_For_and_Get_Input('Preemptive_Priority')
        average_time, processes_list = Preemptive_Priority(Processes_Count, Arrival_Times, Burst_Times, Priorities)
        print(processes_list)
    ...
    elif selected_algorithm.get() == 'SJF_Non_Preemptive':
        Arrival_Times, Burst_Times = Ask_For_and_Get_Input('SJF_Non_Preemptive')
        average_time, processes_list = SJF_Non_Preemptive(Processes_Count, Arrival_Times, Burst_Times)
        print(processes_list)

    elif selected_algorithm.get() == 'SJF_Preemptive':
        Arrival_Times, Burst_Times = Ask_For_and_Get_Input('SJF_Preemptive')
...
def Ask_For_and_Get_Input(algorithm):
    Processes_Count = int(processes_count.get())
    if algorithm == 'FCFS' or algorithm == 'SJF_Non_Preemptive' or algorithm == 'SJF_Preemptive':
        Arrival_Times = list()
        Burst_Times = list()
        for i in range(Processes_Count):
            ...
            top.TextBox_OP.configure(state='normal')
            top.TextBox_OP.delete('1.0', 'end')
            top.TextBox_OP.insert('1.0',
                                  "In the Box below, Please enter the Arrival Time of process {}, then press Enter : ".format(
                                      i + 1))
            top.TextBox_OP.configure(state='disabled')
        ...
        for i in range(Processes_Count):
            ...
            top.TextBox_OP.delete('1.0', 'end')
            top.TextBox_OP.insert('1.0',
                                  "In the Box below, Please enter the Burst Time of process {}, then press Enter : ".format(
                                      i + 1))
            top.TextBox_OP.configure(state='disabled')
    ...
    elif algorithm == 'Preemptive_Priority' or algorithm == 'P_NP':
        Arrival_Times = list()
        Burst_Times = list()
        Priorities = list()
        for i in range(Processes_Count):
        ...
        for i in range(Processes_Count):
            ...
            top.TextBox_OP.delete('1.0', 'end')
            top.TextBox_OP.insert('1.0',
                                  "In the Box below, Please enter the Priority of process {} (zero is highest), then press Enter : ".format(
                                      i + 1))
            top.TextBox_OP.configure(state='disabled')
            top.TextBox_OP.wait_variable(bool)  # wait foor user to press enter in a local event loop
            # add input text to Arrival_Times list
...
def Radiobutton_Preemptive_Priority(b):
    selected_algorithm.set("Preemptive_Priority")
    Preparing_Simulation()
...
def Radiobutton_SJF_Non_Preemptive(b):
    selected_algorithm.set("SJF_Non_Preemptive")
    Preparing_Simulation()


def Radiobutton_SJF_Preemptive(b):
    selected_algorithm.set("SJF_Preemptive")
    Preparing_Simulation()
...
class MainFrame:
    def __init__(self, top=None):
        ...
        top.configure(background="#000655", highlightbackground="#d9d9d9", highlightcolor="black",
        ...
        self.Labelframe1.configure(text='''Scheduling Algorithm''', background="#d9d9d9", highlightbackground="#d9d9d9",
        ...
        self.Labelframe2.configure(text='''Number of Processes''', background="#d9d9d9", highlightbackground="#d9d9d9",
                                   highlightcolor="black")
        ...
        self.Labelframe3.configure(text='''Processes Information''', background="#d9d9d9",
        ...
        self.Labelframe4.configure(text='''Gantt Chart''', background="#d9d9d9", highlightbackground="#d9d9d9",
                                   highlightcolor="black")
        ...
        self.Labelframe5.configure(text='''Average Waiting Time''', background="#d9d9d9", highlightbackground="#d9d9d9",
                                   highlightcolor="black")
        ...
        self.Run_Button.configure(activebackground="#ececec", activeforeground="#000000", background="#d9d9d9",
                                  disabledforeground="#a3a3a3")
        self.Run_Button.configure(foreground="#000000", highlightbackground="#d9d9d9", highlightcolor="black", pady="0",
                                  text='''Run Simulation''')
        ...
        self.Exit_Button.configure(activebackground="#ececec", activeforeground="#000000", background="#d9d9d9",
                                   disabledforeground="#a3a3a3")
        self.Exit_Button.configure(foreground="#000000", highlightbackground="#d9d9d9", highlightcolor="black",
                                   pady="0", text='''Exit''')
        ...
        self.Radiobutton1.configure(activebackground="#d9d9d9", activeforeground="#000000", background="#d9d9d9",
                                    disabledforeground="#a3a3a3")
        self.Radiobutton1.configure(foreground="#000000", highlightbackground="#d9d9d9", highlightcolor="black",
                                    justify='left')
        ...
        self.Radiobutton2.configure(activebackground="#d9d9d9", activeforeground="#000000", background="#d9d9d9",
                                    disabledforeground="#a3a3a3")
        self.Radiobutton2.configure(foreground="#000000", highlightbackground="#d9d9d9", highlightcolor="black",
                                    justify='left')
        self.Radiobutton2.configure(text='''Priority (Preemptive)''', variable=selected_algorithm, value="Preemptive_Priority")
        self.Radiobutton2.bind('<ButtonRelease-1>', Radiobutton_Preemptive_Priority)
        ...
        self.Radiobutton3.configure(activebackground="#d9d9d9", activeforeground="#000000", background="#d9d9d9",
                                    disabledforeground="#a3a3a3")
        self.Radiobutton3.configure(foreground="#000000", highlightbackground="#d9d9d9", highlightcolor="black",
                                    justify='left')
        ...
        self.Radiobutton4.configure(activebackground="#d9d9d9", activeforeground="#000000", background="#d9d9d9",
                                    disabledforeground="#a3a3a3")
        self.Radiobutton4.configure(foreground="#000000", highlightbackground="#d9d9d9", highlightcolor="black",
                                    justify='left')
        self.Radiobutton4.configure(text='''Shortest Job First''', variable=selected_algorithm, value="SJF_Non_Preemptive")
        self.Radiobutton4.bind('<ButtonRelease-1>', Radiobutton_SJF_Non_Preemptive)
        ...
        self.Radiobutton5.configure(activebackground="#d9d9d9", activeforeground="#000000", background="#d9d9d9",
                                    disabledforeground="#a3a3a3")
        self.Radiobutton5.configure(foreground="#000000", highlightbackground="#d9d9d9", highlightcolor="black",
                                    justify='left')
        self.Radiobutton5.configure(text='''Shortest Remaining Time First''', variable=selected_algorithm, value="SJF_Preemptive")
        self.Radiobutton5.bind('<ButtonRelease-1>', Radiobutton_SJF_Preemptive)
        ...
        self.Radiobutton6.configure(activebackground="#d9d9d9", activeforeground="#000000", background="#d9d9d9",
                                    disabledforeground="#a3a3a3")
        self.Radiobutton6.configure(foreground="#000000", highlightbackground="#d9d9d9", highlightcolor="black",
                                    justify='left')
        ...
        self.Spinbox.configure(activebackground="#f9f9f9", background="white", buttonbackground="#d9d9d9",
                               disabledforeground="#a3a3a3", font="TkDefaultFont")
        self.Spinbox.configure(foreground="black", highlightbackground="black", highlightcolor="black",
        ...
        self.TextBox_OP.configure(selectbackground="#c4c4c4", selectforeground="black", state='disabled', undo="1",
                                  wrap="word")
